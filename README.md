...
Constant-Time Execution: Designed to resist timing attacks, verified through 10,000-iteration stability testing.
...
fips202.c /.h : SHA-3 and SHAKE functions required for Kyber hashing.

lwipopts.h : Optimized configuration for the LwIP network stack on the RP2350.

🛠️ Setup & Build
Hardware: 2x Raspberry Pi Pico 2 W

Software: Raspberry Pi Pico SDK, ARM GCC Toolchain(MinGW)

Initialize: Ensure your PICO_SDK_PATH is set.

Configure: Update WIFI_SSID and WIFI_PASSWORD in the main files.
